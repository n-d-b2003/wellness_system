...
import { FitnessItems } from '../weigthsection/Weigthcontext';
...
//      } = useContext(FitnessItems)
  ...
  return (
    ...
    <ScrollView showsVerticalScrollIndicator={false} style={{backgroundColor:"white", marginTop:50}}>
      ...
      {route.params.exercise2.map((item, index=1) =>(
        <Pressable 
    ...
    <Pressable 
    onPress={() => {
      navigation.navigate("Weigth1",{exercise2:route.params.exercise2,})
    setCompleted([])
    }}
    style={{
